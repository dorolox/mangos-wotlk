...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_RATE_DROP_ITEM_GATHERING_RANDOM_MAX,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_RATE_XP_UNTIL_LEVEL_60,
    CONFIG_FLOAT_RATE_XP_UNTIL_LEVEL_70,
    CONFIG_FLOAT_RATE_XP_UNTIL_LEVEL_80,
